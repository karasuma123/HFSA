...
class fsModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        # Generator network
        self.netG = Generator_Adain_Upsample(input_nc=3, output_nc=3, latent_size=512, n_blocks=12, deep=False)
        self.netG.cuda()
        ...
        if self.isTrain:
           ...
           # initialize optimizers
            ...
            # self.optimizer_D_id = torch.optim.Adam(params, lr=opt.lr, betas=(opt.beta1, 0.99),eps=1e-8)
        ...
        if opt.continue_train:
            ...
            # self.load_network(self.netD_id, 'D_id', opt.which_epoch, pretrained_path)
            ...
            # self.load_optim(self.optimizer_D_id, 'D', opt.which_epoch, pretrained_path)
    ...
    def save(self, which_epoch):
        ...
        # self.save_network(self.netD_id, 'D_id', which_epoch)
        self.save_optim(self.optimizer_G, 'G', which_epoch)
        self.save_optim(self.optimizer_D, 'D', which_epoch)
        # self.save_optim(self.optimizer_D_id, 'D', which_epoch)
